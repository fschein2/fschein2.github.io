class Dog {
    ...
    get item() {
        ...
        ul.append(this.listItem(this.size));
...
const showDogs = () => {
    ...
    dogs.push(new Dog("Sam", "golden", "yellow", 1, "medium", "golden-retriever.jpg"));
    ...
    /* const dog = new Dog("Fred", "rotweiler", "brown", 4, "large", "sdfsd");
